...
Duque_tweets_limit = [0.143,0.656]
Duque_authors_limit = [0.084,0.577]

Hashtag_tweets_limit = [0.197,0.4]
Hashtag_authors_limit = [0.162,0.356]
...
Hashtag_file =('DeRusiaLlegan'+hoy)
path = Hashtag_file
